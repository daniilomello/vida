...
function makeEvent(
  ...
  return {
    ...
    path: "/api/v1/cards/card-uuid-1/reactivate",
    pathParameters,
...
describe("reactivateCard", () => {
  ...
  it("should reactivate a card and return 200 with message", async () => {
    ...
    expect(JSON.parse(res.body)).toEqual({ message: "Card reactivated" });
  });
